  ...
  return (
    <div className="container mt-5">
      <section className="mb-5 text-center">
        <h1 className="text-primary mb-4">Desarrollo de Aplicaciones Web</h1>
        <p className="lead">
          Transformamos tus ideas en soluciones digitales efectivas, ofrecemos
          desarrollo web a medida que potencia tu negocio.
        </p>
      </section>
      ...
      {/* Conclusión con imagen de fondo */}
